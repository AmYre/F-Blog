...
ob_start(); ?>
        ...
        <form action="http://localhost/test/app/reading/insert_comment/<?php echo $id ?>/<?php echo $h1 ?>" method="post">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="http://localhost/test/app/reading/updateANDdelete_comment/<?php echo $id ?>/<?php echo $h1 ?>" method="post">
